...
import { FaStrikethrough, FaSubscript, FaSuperscript, FaHighlighter } from "react-icons/fa";
...
`;
    ...
    }, [viewSource, mounted]); // Re-init when switching back from source view
            ...
            <div className="rte-modal">
                ...
                {!viewSource && (
                    <div className="rte-toolbar">
                        ...
                        <div className="rte-toolbar-group">
                            <div className="rte-color-wrapper hover:bg-gray-200 rounded" title="Text Color">
                        ...
                        <div className="rte-toolbar-group">
                            ...
                            <ToolbarButton icon={<FaSubscript />} onClick={() => execCmd("subscript")} label="Subscript" />
                            <ToolbarButton icon={<FaSuperscript />} onClick={() => execCmd("superscript")} label="Superscript" />
                        </div>
