...
import { useGetProjectsQuery, useDeleteProjectMutation } from '@/store/services/projectsApi';
            ...
            >
                <div className='d-flex justify-content-between align-items-end gap-3'>
                    <div className="text-start">
                        <h1 className="fw-bold display-4 text-white mb-2">Featured Projects</h1>
                    ...
                    {isMounted && isAuthenticated && (
                        <div className="mb-1">
                            <Link href="/dashboard" className="btn btn-primary rounded-pill px-4 text-nowrap">
                                + Add New Project
                            </Link>
                        </div>
                    )}
                            ...
                            >
                                {isMounted && role === 'admin' && (
                                    <div className="position-absolute top-0 end-0 p-3">
                                        <button
                                            onClick={(e) => { e.stopPropagation(); handleView(project._id); }}
                                ...
                                <h3
                                    className="h4 fw-bold mt-2 mb-3 text-white"
                                    style={{
                                        whiteSpace: 'nowrap',
                                        overflowX: 'auto',
