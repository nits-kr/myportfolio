...
const RegisterPage = () => {
    ...
    const inputClass = "w-full p-3 mb-4 bg-gray-800 rounded border border-gray-700 focus:border-blue-500 focus:outline-none text-white transition-colors duration-200";
